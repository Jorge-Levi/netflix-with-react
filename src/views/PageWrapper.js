            ...
            >
              <ul className="nav navbar-nav flex-child-menu menu-left">
                  ...
                  <ul className="dropdown-menu level1">
                    <li className="dropdown">
                      ...
                      <ul className="dropdown-menu level2">
                        <li>
                          <a href="moviegrid_light.html">Movie grid</a>
                        </li>
                        <li>
                          <a href="moviegridfw_light.html">
                    ...
                    <li>
                      <a href="movielist_light.html">Movie list</a>
                    </li>
                    <li>
                      <a href="moviesingle_light.html">Movie single</a>
                    </li>
                    <li className="it-last">
                      <a href="seriessingle_light.html">Series single</a>
                    </li>
                  </ul>
                </li>
                <li className="dropdown first">
                  ...
                  <ul className="dropdown-menu level1">
                    <li>
                      <a href="celebritygrid01_light.html">celebrity grid 01</a>
                    </li>
                    <li>
                      <a href="celebritygrid02_light.html">
                        celebrity grid 02{" "}
                      </a>
                    </li>
                    <li>
                      <a href="celebritylist_light.html">celebrity list</a>
                    </li>
                    <li className="it-last">
                      <a href="celebritysingle_light.html">celebrity single</a>
                    </li>
                  </ul>
                </li>
                <li className="dropdown first">
                ...
                <li className="dropdown first">
                  ...
                  <ul className="dropdown-menu level1">
                    <li>
                      <a href="userfavoritegrid_light.html">
                        user favorite grid
                      </a>
                    </li>
                    <li>
                      <a href="userfavoritelist_light.html">
                        user favorite list
                      </a>
                    </li>
                    <li>
                      <a href="userprofile_light.html">user profile</a>
                    </li>
                    <li className="it-last">
                      <a href="userrate_light.html">user rate</a>
                    </li>
                  </ul>
                </li>
              </ul>
            ...
            <div className="row ipad-width2">
              <div className="col-md-8 col-sm-12 col-xs-12">
                <div className="topbar-filter">
                  ...
                  <a href="movielist_light.html" className="list">
                    <i className="ion-ios-list-outline active" />
                  </a>
                  <a href="moviegrid_light.html" className="grid">
